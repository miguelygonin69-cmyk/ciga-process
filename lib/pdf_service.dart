// Assurez-vous que ce fichier est dans lib/pdf_service.dart
import 'dart:io';
    ...
    pdf.addPage(
      pw.Page(
        ...
        build: (pw.Context context) {
          // Utilisation du Container pour le fond Noir
          return pw.Container(
              color: primaryColor,
              child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Container(
                      ...
                      child: pw.Text(
                        ...
                        style:
                            pw.TextStyle(fontSize: 12, color: foregroundColor),
                      ),
                    ),
                    ...
                    pw.Text(
                      ...
                      textAlign: pw.TextAlign.justify,
                      style:
                          pw.TextStyle(fontSize: 11, color: foregroundColor),
                    ),
